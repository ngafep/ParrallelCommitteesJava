...
import com.engie.csai.pc.pbftSimulatorold2.message.CliTimeOutMsg;
import com.engie.csai.pc.pbftSimulatorold2.message.Message;
import com.engie.csai.pc.pbftSimulatorold2.message.ReplyMsg;
import com.engie.csai.pc.pbftSimulatorold2.message.RequestMsg;
...
public class Client
{
    ...
    public void msgProcess(PBFTsimulator pbfTsimulator, Message msg)
    {
        ...
        {
            case Message.REPLY:
                receiveReply(msg, pbfTsimulator);
                break;
    ...
    ,String messageClientRequest/*I added here a new parameter as String message i.e. client-request*/)
    {
        ...
        int priId = viewNumber % pbfTsimulator.getNbPeers(); //priId: Primary Id (Leader Id).
    ...
    public void receiveReply(Message msg, PBFTsimulator pbfTsimulator)
    {
        ...
        if (isStable(repMsg, pbfTsimulator))
        {
    ...
    public void receiveCliTimeOut(PBFTsimulator pbfTsimulator, Message msg)
    {
        ...
        for (int i = 0; i < pbfTsimulator.getNbPeers(); i++)
        {
     ...
     */
    public boolean isStable(ReplyMsg msg, PBFTsimulator pbfTsimulator)
    {
        Map<Integer, Message> rMap = repMsgs.get(msg.clientReqTimeStamp);
        int cnt = 0;
        for (Integer i : rMap.keySet())
        ...
        if (cnt > Utils.getMaxTorelentNumber(pbfTsimulator.getNbPeers())) return true;
        return false;
    }
